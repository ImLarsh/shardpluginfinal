        ...
        if (setSection != null) {
            ...
            if (armorSection != null && piecesSection != null) {
                ...
                if (meta != null) {
                    ...
                    final ConfigurationSection enchantSection = armorSection.getConfigurationSection("enchantments");
                    ...
                    // Set base attack attributes to 0 if hide_attributes is true
                    if (armorSection.getBoolean("hide_attributes", false)) {
                        meta.addAttributeModifier(
